...
static partial class Program
{
        ...
        string queueId)
    {
        ...
        var treeProductTreeType = ReadQueueParameterString(item, "tree_product_tree_type");
        var expectedTreeHasSeedBefore = ReadNullableBoolQueueParameter(item, "expected_tree_has_seed_before");
        var expectedTreeHasSeedAfter = ReadNullableBoolQueueParameter(item, "expected_tree_has_seed_after");
        var expectedTreeWasShakenTodayBefore = ReadNullableBoolQueueParameter(item, "expected_tree_was_shaken_today_before");
        var expectedTreeWasShakenTodayAfter = ReadNullableBoolQueueParameter(item, "expected_tree_was_shaken_today_after");
        var treeProductOutputDomainJson = ReadQueueParameterString(item, "tree_product_output_domain_json");
        var treeProductOutputDomainContract = ReadQueueParameterString(item, "tree_product_output_domain_contract");
        var treeProductProjectionStatus = ReadQueueParameterString(item, "tree_product_projection_status");
        var treeProductNativeContract = ReadQueueParameterString(item, "tree_product_native_contract");
        var treeChopTreeType = ReadQueueParameterString(item, "tree_chop_tree_type");
        var treeChopDataContractStatus = ReadQueueParameterString(item, "tree_chop_data_contract_status");
        var treeChopProtectionStatus = ReadQueueParameterString(item, "tree_chop_protection_status");
        var treeChopProjectionStatus = ReadQueueParameterString(item, "tree_chop_projection_status");
        var treeChopOutputDomainContract = ReadQueueParameterString(item, "tree_chop_output_domain_contract");
        var treeChopGuaranteedMinimumOutputsJson = ReadQueueParameterString(item, "tree_chop_guaranteed_minimum_outputs_json");
        var treeChopOutputDomainJson = ReadQueueParameterString(item, "tree_chop_output_domain_json");
        var treeChopNativeContract = ReadQueueParameterString(item, "tree_chop_native_contract");
        var expectedTreePresentAfter = ReadNullableBoolQueueParameter(item, "expected_tree_present_after");
        var expectedTreesChoppedBefore = ReadQueueParameterLong(item, "expected_trees_chopped_before");
        var expectedTreesChoppedDelta = ReadQueueParameterLong(item, "expected_trees_chopped_delta");
        var expectedTreesChoppedAfter = ReadQueueParameterLong(item, "expected_trees_chopped_after");
        var garbageCanAction = ReadQueueParameterString(item, "garbage_can_action");
        var garbageCanId = ReadQueueParameterString(item, "garbage_can_id");
        var expectedCheckedTodayBefore = ReadNullableBoolQueueParameter(item, "expected_checked_today_before");
        var expectedCheckedTodayAfter = ReadNullableBoolQueueParameter(item, "expected_checked_today_after");
        var expectedTrashCansCheckedBefore = ReadQueueParameterInt(item, "expected_trash_cans_checked_before");
        var expectedTrashCansCheckedDelta = ReadQueueParameterInt(item, "expected_trash_cans_checked_delta");
        var expectedDailyLuck = ReadQueueParameterDouble(item, "expected_daily_luck");
        var expectedAlleywayBuffetRead = ReadNullableBoolQueueParameter(item, "expected_alleyway_buffet_read");
        var predictedItemProduced = ReadNullableBoolQueueParameter(item, "predicted_item_produced");
        var selectedEntryId = ReadQueueParameterString(item, "selected_entry_id");
        var selectedIgnoreBaseChance = ReadNullableBoolQueueParameter(item, "selected_ignore_base_chance");
        var selectedMegaSuccess = ReadNullableBoolQueueParameter(item, "selected_mega_success");
        var selectedDoubleMegaSuccess = ReadNullableBoolQueueParameter(item, "selected_double_mega_success");
        var outputDelivery = ReadQueueParameterString(item, "output_delivery");
        var expectedOutputJson = ReadQueueParameterString(item, "expected_output_json");
        var reactingNpcJson = ReadQueueParameterString(item, "reacting_npc_json");
        var garbageCanDataPayloadSha256 = ReadQueueParameterString(item, "garbage_can_data_payload_sha256");
        var garbageCanDataContractStatus = ReadQueueParameterString(item, "garbage_can_data_contract_status");
        var garbageCanPredictionStatus = ReadQueueParameterString(item, "garbage_can_prediction_status");
        var garbageCanProjectionFingerprint = ReadQueueParameterString(item, "garbage_can_projection_fingerprint");
        var garbageCanNativeContract = ReadQueueParameterString(item, "garbage_can_native_contract");
        ...
        var secretNoteRuntimeType = ReadQueueParameterString(item, "secret_note_runtime_type");
        var secretNoteStackBefore = ReadQueueParameterInt(item, "secret_note_stack_before");
        var secretNoteStackAfter = ReadQueueParameterInt(item, "secret_note_stack_after");
        var secretNoteIsJournal = ReadNullableBoolQueueParameter(item, "secret_note_is_journal");
        var secretNoteJournalIndex = ReadQueueParameterInt(item, "secret_note_journal_index");
        var secretNoteTotalCount = ReadQueueParameterInt(item, "secret_note_total_count");
        var secretNoteUnseenIdsNativeOrderJson = ReadQueueParameterString(item, "secret_note_unseen_ids_native_order_json");
        var secretNoteUnseenCount = ReadQueueParameterInt(item, "secret_note_unseen_count");
        var secretNoteSelectionKind = ReadQueueParameterString(item, "secret_note_selection_kind");
        var secretNoteSelectedId = ReadQueueParameterInt(item, "secret_note_selected_id");
        var secretNoteContentSha256 = ReadQueueParameterString(item, "secret_note_content_sha256");
        var secretNoteDisplayKind = ReadQueueParameterString(item, "secret_note_display_kind");
        var secretNoteExpectedImage = ReadQueueParameterInt(item, "secret_note_expected_image");
        var secretNoteExpectedWhichBackground = ReadQueueParameterInt(item, "secret_note_expected_which_bg");
        var secretNoteExpectedQuestId = ReadQueueParameterString(item, "secret_note_expected_quest_id");
        var secretNoteExpectedQuestPresentBefore = ReadNullableBoolQueueParameter(item, "secret_note_expected_quest_present_before");
        var secretNoteExpectedQuestPresentAfter = ReadNullableBoolQueueParameter(item, "secret_note_expected_quest_present_after");
        var secretNoteProjectionFingerprint = ReadQueueParameterString(item, "secret_note_projection_fingerprint");
        var secretNoteNativeContract = ReadQueueParameterString(item, "secret_note_native_contract");
        ...
        executionRequest.TreeProductTreeType = treeProductTreeType;
        executionRequest.ExpectedTreeHasSeedBefore = expectedTreeHasSeedBefore;
        executionRequest.ExpectedTreeHasSeedAfter = expectedTreeHasSeedAfter;
        executionRequest.ExpectedTreeWasShakenTodayBefore = expectedTreeWasShakenTodayBefore;
        executionRequest.ExpectedTreeWasShakenTodayAfter = expectedTreeWasShakenTodayAfter;
        executionRequest.TreeProductOutputDomainJson = treeProductOutputDomainJson;
        executionRequest.TreeProductOutputDomainContract = treeProductOutputDomainContract;
        executionRequest.TreeProductProjectionStatus = treeProductProjectionStatus;
        executionRequest.TreeProductNativeContract = treeProductNativeContract;
        executionRequest.TreeChopTreeType = treeChopTreeType;
        executionRequest.TreeChopDataContractStatus = treeChopDataContractStatus;
        executionRequest.TreeChopProtectionStatus = treeChopProtectionStatus;
        executionRequest.TreeChopProjectionStatus = treeChopProjectionStatus;
        executionRequest.TreeChopOutputDomainContract = treeChopOutputDomainContract;
        executionRequest.TreeChopGuaranteedMinimumOutputsJson = treeChopGuaranteedMinimumOutputsJson;
        executionRequest.TreeChopOutputDomainJson = treeChopOutputDomainJson;
        executionRequest.TreeChopNativeContract = treeChopNativeContract;
        executionRequest.ExpectedTreePresentAfter = expectedTreePresentAfter;
        executionRequest.ExpectedTreesChoppedBefore = expectedTreesChoppedBefore;
        executionRequest.ExpectedTreesChoppedDelta = expectedTreesChoppedDelta;
        executionRequest.ExpectedTreesChoppedAfter = expectedTreesChoppedAfter;
        executionRequest.GarbageCanAction = garbageCanAction;
        executionRequest.GarbageCanId = garbageCanId;
        executionRequest.ExpectedCheckedTodayBefore = expectedCheckedTodayBefore;
        executionRequest.ExpectedCheckedTodayAfter = expectedCheckedTodayAfter;
        executionRequest.ExpectedTrashCansCheckedBefore = expectedTrashCansCheckedBefore;
        executionRequest.ExpectedTrashCansCheckedDelta = expectedTrashCansCheckedDelta;
        executionRequest.ExpectedDailyLuck = expectedDailyLuck;
        executionRequest.ExpectedAlleywayBuffetRead = expectedAlleywayBuffetRead;
        executionRequest.PredictedItemProduced = predictedItemProduced;
        executionRequest.SelectedEntryId = selectedEntryId;
        executionRequest.SelectedIgnoreBaseChance = selectedIgnoreBaseChance;
        executionRequest.SelectedMegaSuccess = selectedMegaSuccess;
        executionRequest.SelectedDoubleMegaSuccess = selectedDoubleMegaSuccess;
        executionRequest.OutputDelivery = outputDelivery;
        executionRequest.ExpectedOutputJson = expectedOutputJson;
        executionRequest.ReactingNpcJson = reactingNpcJson;
        executionRequest.GarbageCanDataPayloadSha256 = garbageCanDataPayloadSha256;
        executionRequest.GarbageCanDataContractStatus = garbageCanDataContractStatus;
        executionRequest.GarbageCanPredictionStatus = garbageCanPredictionStatus;
        executionRequest.GarbageCanProjectionFingerprint = garbageCanProjectionFingerprint;
        executionRequest.GarbageCanNativeContract = garbageCanNativeContract;
        ...
        executionRequest.SecretNoteRuntimeType = secretNoteRuntimeType;
        executionRequest.SecretNoteStackBefore = secretNoteStackBefore;
        executionRequest.SecretNoteStackAfter = secretNoteStackAfter;
        executionRequest.SecretNoteIsJournal = secretNoteIsJournal;
        executionRequest.SecretNoteJournalIndex = secretNoteJournalIndex;
        executionRequest.SecretNoteTotalCount = secretNoteTotalCount;
        executionRequest.SecretNoteUnseenIdsNativeOrderJson = secretNoteUnseenIdsNativeOrderJson;
        executionRequest.SecretNoteUnseenCount = secretNoteUnseenCount;
        executionRequest.SecretNoteSelectionKind = secretNoteSelectionKind;
        executionRequest.SecretNoteSelectedId = secretNoteSelectedId;
        executionRequest.SecretNoteContentSha256 = secretNoteContentSha256;
        executionRequest.SecretNoteDisplayKind = secretNoteDisplayKind;
        executionRequest.SecretNoteExpectedImage = secretNoteExpectedImage;
        executionRequest.SecretNoteExpectedWhichBackground = secretNoteExpectedWhichBackground;
        executionRequest.SecretNoteExpectedQuestId = secretNoteExpectedQuestId;
        executionRequest.SecretNoteExpectedQuestPresentBefore = secretNoteExpectedQuestPresentBefore;
        executionRequest.SecretNoteExpectedQuestPresentAfter = secretNoteExpectedQuestPresentAfter;
        executionRequest.SecretNoteProjectionFingerprint = secretNoteProjectionFingerprint;
        executionRequest.SecretNoteNativeContract = secretNoteNativeContract;
        ...
        ApplyStoragePlacementRequestFields(
            executionRequest,
            item);
        ApplyTentPlacementRequestFields(
            executionRequest,
            item);

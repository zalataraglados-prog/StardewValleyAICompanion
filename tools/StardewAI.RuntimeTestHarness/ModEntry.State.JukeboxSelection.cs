...
{
    private sealed class ActiveJukeboxSelection : INativeObjectInteractionMovement
    {
        public ActiveJukeboxSelection(PendingExecution pending, GameLocation location, Point target, Point stand,
        ...
        public int ForwardClicks { get; set; }

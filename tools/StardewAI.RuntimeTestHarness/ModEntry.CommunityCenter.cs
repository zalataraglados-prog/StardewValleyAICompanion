...
public sealed partial class ModEntry
{
    private void StartCommunityCenterDonation(PendingExecution pending)
    {
        ...
        if (activeCommunityCenterDonation is not null || activeCommunityCenterVaultPayment is not null || activeCommunityCenterRewardClaim is not null || Game1.activeClickableMenu is not null || Game1.dialogueUp || Game1.player.UsingTool || !Game1.player.CanMove)
        {

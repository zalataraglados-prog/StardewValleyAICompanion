...
- **Authoritative acquisition calendar sources** - The four Stage 1 collection denominators retain all 1,599
  ...
  target-location/terminal probability. The focused fixture preserves 76/76 rows, passes the deterministic shop route,
  and explicitly blocks remote Beach fishing. The shared success target is 0.95. Retry-expanded consumables must pass
  final resource/currency/atomic-reservation validation; a one-attempt claim set cannot authorize a multi-attempt plan.
  ...
  generic fish acceptance for a specific tile/context. Training authorization remains false. That terminal fishing
  evaluator and retry reservation loopback are next, followed by `daily_time_energy_budget`.

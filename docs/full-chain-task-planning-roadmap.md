...
- **Authoritative acquisition calendar sources** - The four Stage 1 collection denominators retain all 1,599
  ...
  route kinds; every resolved route remains target-date pending and cannot authorize training. The next slice
  evaluates these source windows for explicit target dates before composing the other dependency axes.

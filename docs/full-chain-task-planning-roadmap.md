...
- **Authoritative acquisition calendar sources** - The four Stage 1 collection denominators retain all 1,599
  ...
  one-unit gain for a two-unit requirement. Formal training authorization remains false until route composition,
  atomic reservation commit and rollout-controller admission are complete.

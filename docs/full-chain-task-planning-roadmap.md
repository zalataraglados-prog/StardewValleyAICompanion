...
- **Authoritative acquisition calendar sources** - The four Stage 1 collection denominators retain all 1,599
  ...
  denominator reconstruction, gated incomparable-frontier selection and complete 19/19 Teacher coverage remain before
  the repeated path can feed formal product training.

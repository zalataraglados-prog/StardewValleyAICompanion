...
- **Authoritative acquisition calendar sources** - The four Stage 1 collection denominators retain all 1,599
  ...
  proof-manifest verifier are also implemented. Formal training authorization remains false until controller admission
  consumes its verified terminal receipt and a three-or-more-transition fixture closes the repeated path.

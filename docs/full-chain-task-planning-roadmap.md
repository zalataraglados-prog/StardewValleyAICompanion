...
- **Authoritative acquisition calendar sources** - The four Stage 1 collection denominators retain all 1,599
  ...
  variants are independently asserted. This proves only one route occurrence. Cross-route double spending, future
  income and durable allocation remain owned by the next `inventory_reservation` axis. Training authorization remains
  false.

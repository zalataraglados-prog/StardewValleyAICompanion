...
- **Authoritative acquisition calendar sources** - The four Stage 1 collection denominators retain all 1,599
  ...
  and per-route dispatch ownership are now typed as described below. Formal training authorization remains false
  until independent portfolio preference, ordered portfolio rollout/completion and controller admission are complete.

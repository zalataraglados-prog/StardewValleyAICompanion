...
- **Authoritative acquisition calendar sources** - The four Stage 1 collection denominators retain all 1,599
  ...
  first post-route settlement/checkpoint are also implemented. Formal training authorization remains false until
  cumulative completed alternatives feed a fresh current-state Teacher denominator, multi-transition rollout reaches
  a verified portfolio completion, and controller admission consumes that proof.

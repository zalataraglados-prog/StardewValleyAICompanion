...
- **Authoritative acquisition calendar sources** - The four Stage 1 collection denominators retain all 1,599
  ...
  evidence. This scoped admission does not authorize `formal_product_training`; the portfolio supervision dataset
  adapter remains before the repeated path can feed formal training.

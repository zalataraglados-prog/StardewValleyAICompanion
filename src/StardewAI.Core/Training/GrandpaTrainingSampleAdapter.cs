    ...
    public sealed class GrandpaTrainingSampleAdapter
    {
        ...
        private static CandidateDirection[] BuildDirections(GrandpaEvaluationGoalReport report, bool globalBlocked)
        {
            ...
            var specs = new[]
            {
                ...
                Spec("complete_or_unlock_community_center", "world_progress", "Complete or unlock Community Center", "grandpa.community_center", new[] { "community_center_access_or_completion", "community_center_accessible_bonus" }),

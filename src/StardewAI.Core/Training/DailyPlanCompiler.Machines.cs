...
namespace StardewAI.Core.Training
{
    public sealed partial class DailyPlanCompiler
    {
        ...
        private static IEnumerable<SmallModelPlanStep> LoadMachineInputSteps(PolicyEventCandidatePrediction candidate)
        {
            ...
            AddParsedParameter(parameters, candidate.ExpectedEffect, "anvil_reforge_loadout_status");
            AddParsedParameter(parameters, candidate.ExpectedEffect, "anvil_reforge_capability_class");
            AddParsedParameter(parameters, candidate.ExpectedEffect, "anvil_reforge_kill_credit_policy");
            AddParsedParameter(parameters, candidate.ExpectedEffect, "anvil_reforge_loot_policy");
            AddParsedParameter(parameters, candidate.ExpectedEffect, "anvil_reforge_unlocked_slot_count");
            AddParsedParameter(parameters, candidate.ExpectedEffect, "anvil_reforge_occupied_slot_count");
            AddParsedParameter(parameters, candidate.ExpectedEffect, "anvil_reforge_empty_unlocked_slot_count");
            AddParsedParameter(parameters, candidate.ExpectedEffect, "anvil_reforge_same_type_equipped_count");
            AddParsedParameter(parameters, candidate.ExpectedEffect, "anvil_reforge_other_type_equipped_count");
            AddParsedParameter(parameters, candidate.ExpectedEffect, "anvil_reforge_loadout_relation");
            AddParsedParameter(parameters, candidate.ExpectedEffect, "anvil_reforge_goal_demand_status");
            AddParsedParameter(parameters, candidate.ExpectedEffect, "anvil_reforge_goal_family");
            AddParsedParameter(parameters, candidate.ExpectedEffect, "anvil_reforge_goal_capability_affinity");
            AddParsedParameter(parameters, candidate.ExpectedEffect, "anvil_reforge_loadout_adjustment");
            AddParsedParameter(parameters, candidate.ExpectedEffect, "anvil_reforge_effective_demand_score");
            AddParsedParameter(parameters, candidate.ExpectedEffect, "anvil_reforge_goal_demand_reason");
            ...
            AddParsedParameter(parameters, candidate.ExpectedEffect, "incubator_animal_house_occupant_count");
            AddParsedParameter(parameters, candidate.ExpectedEffect, "incubator_animal_house_occupant_limit");
            AddParsedParameter(parameters, candidate.ExpectedEffect, "incubator_animal_purchase_equivalent_value");

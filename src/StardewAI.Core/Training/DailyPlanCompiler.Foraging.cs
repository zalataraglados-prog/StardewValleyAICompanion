    ...
    public sealed partial class DailyPlanCompiler
    {
        private static IEnumerable<SmallModelPlanStep> CollectSpawnedObjectSteps(PolicyEventCandidatePrediction candidate)
        {
            ...
            var parameters = new List<SmallModelActionParameter>
            {
                ...
                Parameter("expected_output_quality", ParseValue(candidate.ExpectedEffect, "projected_harvest_quality=")),
                ...
                Parameter("expected_foraging_experience_delta", ParseValue(candidate.ExpectedEffect, "foraging_experience_on_success_min=")),
                ...
                Parameter("expected_farming_experience_delta", ParseValue(candidate.ExpectedEffect, "farming_experience_on_success_min=")),

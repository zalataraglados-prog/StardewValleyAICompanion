...
public sealed partial class DailyPlanCompiler
{
    private static IEnumerable<SmallModelPlanStep> ConstructQuestBuildingSteps(PolicyEventCandidatePrediction candidate)
    {
        var names = new[]
        {
            "construction_purpose", "construction_reason", "construction_building_type", "project_id", "construction_builder", "construction_build_days", "construction_build_cost", "price",
            ...
            "carpenter_action_raw", "builder_action_raw", "native_contract", "quest_candidate_id", "quest_family", "quest_id",

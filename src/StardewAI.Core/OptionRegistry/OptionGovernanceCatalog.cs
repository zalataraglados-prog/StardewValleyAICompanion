    ...
    internal static class OptionGovernanceCatalog
    {
        ...
        private static IReadOnlyDictionary<string, OptionGovernancePolicy> BuildPolicies()
        {
            var rows = new[]
            {
                ...
                P("tailoring.sew_item", C, R2, Consume, PolicyConfirm, Actor, Inventory, Policy),
                ...
                P("foraging.harvest_spring_onions", C, R1, None, NoConfirm, Actor, Inventory, Allowed),
                ...
                P("executor.tailor_item", Primitive, R2, Consume, PolicyConfirm, Actor, Inventory, Policy),
                ...
                P("executor.pay_community_center_vault_bundle", Primitive, R4, Asset, ExplicitConfirm, Actor, World, Explicit),

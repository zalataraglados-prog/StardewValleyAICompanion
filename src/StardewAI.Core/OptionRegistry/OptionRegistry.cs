...
namespace StardewAI.Core.OptionRegistry
{
    public sealed class OptionRegistry
    {
        ...
        public OptionRegistry()
        {
            ...
            Register(Option("foraging.chop_wild_tree", "foraging", "Chop one transparent mature wild Tree through its complete native lifecycle",
                OptionBehaviorCategories.ParameterizedMechanical,
                CompilerResponsibilities.ParameterExpansion,
                TrainingRoles.Mixed,
                new[] { "player.location_id", "player.tile_x", "player.tile_y", "player.energy", "player.inventory", "player.skills_detail", "current_location.terrain_features", "current_location.debris", "locations.collision_grid", "menus.active_menu" },
                new[] { "one exact mature seedless and mossless base Tree selected", "locked Data/WildTrees guaranteed minima and complete stochastic output domain retained without consuming RNG", "existing clear_obstacle native Axe lifecycle reused through trunk fall, stump removal, and falling settlement" },
                new[] { "block_tree_seed_or_moss_must_be_harvested_first", "block_custom_or_data_drifted_tree", "block_native_town_tree_protection", "block_missing_axe", "block_native_fall_or_shake_in_progress", "block_insufficient_energy", "block_unverified_adjacent_route", "block_projection_drift", "block_direct_tree_rng_debris_inventory_stat_or_skill_mutation" }));
            ...
            Register(Option("executor.pay_community_center_vault_bundle", "community_center", "Pay one exact Vault bundle through the native Junimo Note purchase button",
                OptionBehaviorCategories.Mechanical,
                CompilerResponsibilities.FullActionExpansion,
                TrainingRoles.ExecutorCalibration,
                new[] { "player.location_id", "player.tile_x", "player.tile_y", "player.money", "world_progress.community_center", "locations.collision_grid", "menus.active_menu" },
                new[] { "BFS reaches the exact Vault note", "native Junimo Note purchase button deducts the exact live amount", "native bundle reward and area lifecycle effects settle" },
                new[] { "block_joja_locked_or_route_conflict", "block_bundle_money_or_source_drift", "block_insufficient_money_or_note_mutex_drift", "block_unverified_route", "block_direct_money_bundle_reward_or_area_mutation" }));

...
namespace StardewAI.Core.Execution
{
    public sealed partial class ActionQueueCompiler
    {
            ...
            StrategyCommitmentLedger? commitmentLedger)
        {
            ...
            blocking.AddRange(ValidatePlantGrassPlan(action, snapshot));
            ...
            blocking.AddRange(ValidateHarvestFruitTreePlan(action, snapshot));
            blocking.AddRange(ValidateHarvestWildTreeProductPlan(action, snapshot));
            blocking.AddRange(ValidateRummageGarbagePlan(action, snapshot));
            blocking.AddRange(ValidateMineRewardChestPlan(action, snapshot));
            blocking.AddRange(ValidateCalicoStatuePlan(action, snapshot));
            blocking.AddRange(ValidateMultiplayerWalletPlan(action, snapshot));
            blocking.AddRange(ValidateMultiplayerChatPlan(action, snapshot));
            blocking.AddRange(ValidateBobberSelectionPlan(action, snapshot));
            blocking.AddRange(ValidateJukeboxSelectionPlan(action, snapshot));
            blocking.AddRange(ValidatePlayerCustomizationPlan(action, snapshot));
            ...
            blocking.AddRange(ValidateMasteryClaimPlan(action, snapshot));
            blocking.AddRange(ValidatePlayerEmotePlan(action, snapshot));
            blocking.AddRange(ValidateWatchMoviePlan(action, snapshot));
            blocking.AddRange(ValidateAdvanceStoryEventPlan(action, snapshot));
            blocking.AddRange(ValidateAdvanceStoryEventMinigamePlan(action, snapshot));
            ...
            blocking.AddRange(ValidateSingingStonePlan(action, snapshot));
            blocking.AddRange(ValidateFluteBlockPlan(action, snapshot));
            blocking.AddRange(ValidateDrumBlockPlan(action, snapshot));
            blocking.AddRange(ValidateFarmComputerPlan(action, snapshot));
            blocking.AddRange(ValidateSlimeBallPlan(action, snapshot));
            blocking.AddRange(ValidateFeedHopperPlan(action, snapshot));
            blocking.AddRange(ValidateAutoGrabberPlan(action, snapshot));
            blocking.AddRange(ValidateMiniObeliskPlan(action, snapshot));
            blocking.AddRange(ValidateCollectCrabPotPlan(action, snapshot));
            blocking.AddRange(ValidateFishPondPlan(action, snapshot));
            blocking.AddRange(ValidateFishPondManagementPlan(action, snapshot));
            ...
            blocking.AddRange(ValidateFieldOfficeDonationPlan(action, snapshot));
            blocking.AddRange(ValidateFieldOfficeSurveyPlan(action, snapshot));
            blocking.AddRange(ValidateCalicoJackPlan(action, snapshot));
            blocking.AddRange(ValidateSlotsPlan(action, snapshot));
            ...
            blocking.AddRange(ValidateFairStrengthGamePlan(action, snapshot));
            blocking.AddRange(ValidateFairWheelSpinPlan(action, snapshot));
            blocking.AddRange(ValidateCommunityCenterDonationPlan(action, snapshot));
            blocking.AddRange(ValidateCommunityCenterRewardPlan(action, snapshot));
            blocking.AddRange(ValidateCommunityCenterMoneyPaymentPlan(action, snapshot));
            ...
            blocking.AddRange(ValidateReadSecretNotePlan(action, snapshot));
            blocking.AddRange(ValidateUseFireworkPlan(action, snapshot));
            blocking.AddRange(ValidateUseHorseFlutePlan(action, snapshot));
            blocking.AddRange(ValidateUseMonsterMuskPlan(action, snapshot));
            ...
            blocking.AddRange(ValidateTailorItemPlan(action, snapshot));

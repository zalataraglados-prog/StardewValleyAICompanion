...
namespace StardewAI.Core.Execution
{
    public sealed partial class ActionQueueCompiler
    {
        ...
        private static readonly IReadOnlyDictionary<string, ActionStepCompiler> ActionStepCompilers =
            ...
            {
                ["recovery.stabilize_day"] = CompileRecoverySteps,
                ...
                ["quest.cancel"] = CompileQuestCancellationStep,
                ["executor.cancel_quest"] = CompileQuestCancellationStep,
                ["rewards.claim_adventure_guild_reward"] = CompileAdventureGuildRewardStep,
                ["executor.claim_adventure_guild_reward"] = CompileAdventureGuildRewardStep,
                ["rewards.claim_prize_ticket"] = CompilePrizeTicketRewardStep,
                ["executor.claim_prize_ticket"] = CompilePrizeTicketRewardStep,
                ["skills.claim_mastery"] = CompileMasteryClaimStep,
                ["executor.claim_mastery"] = CompileMasteryClaimStep,
                ...
                ["executor.advance_story_event_minigame"] = CompileAdvanceStoryEventMinigameStep,
                ...
                ["player.choose_bobber"] = CompileBobberSelectionStep,
                ["executor.choose_bobber_style"] = CompileBobberSelectionStep,
                ["player.choose_jukebox_track"] = CompileJukeboxSelectionStep,
                ["executor.choose_jukebox_track"] = CompileJukeboxSelectionStep,
                ["player.customize"] = CompilePlayerCustomizationStep,
                ["executor.customize_player"] = CompilePlayerCustomizationStep,
                ["processing.crack_geode"] = CompileGeodeProcessingStep,
                ["executor.crack_geode"] = CompileGeodeProcessingStep,
        ...
        private static readonly IReadOnlyDictionary<string, ActionParameterCompiler> ActionParameterCompilers =
            new Dictionary<string, ActionParameterCompiler>(StringComparer.Ordinal)
            {
                ...
                ["player.choose_bobber"] = BuildBobberSelectionParameters,
                ["executor.choose_bobber_style"] = BuildBobberSelectionParameters,
                ["player.choose_jukebox_track"] = BuildJukeboxSelectionParameters,
                ["executor.choose_jukebox_track"] = BuildJukeboxSelectionParameters,
                ["player.customize"] = BuildPlayerCustomizationParameters,
                ["executor.customize_player"] = BuildPlayerCustomizationParameters,
                ["processing.crack_geode"] = BuildGeodeProcessingParameters,
                ["executor.crack_geode"] = BuildGeodeProcessingParameters,
                ["quest.cancel"] = BuildQuestCancellationParameters,
                ["executor.cancel_quest"] = BuildQuestCancellationParameters,
                ["rewards.claim_adventure_guild_reward"] = BuildAdventureGuildRewardParameters,
                ["executor.claim_adventure_guild_reward"] = BuildAdventureGuildRewardParameters,
                ["rewards.claim_prize_ticket"] = BuildPrizeTicketRewardParameters,
                ["executor.claim_prize_ticket"] = BuildPrizeTicketRewardParameters,
                ["skills.claim_mastery"] = BuildMasteryClaimParameters,
                ["executor.claim_mastery"] = BuildMasteryClaimParameters,
                ["social.emote"] = BuildPlayerEmoteParameters,
                ["executor.perform_emote"] = BuildPlayerEmoteParameters,

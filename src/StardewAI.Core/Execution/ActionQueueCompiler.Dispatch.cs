    ...
    public sealed partial class ActionQueueCompiler
    {
        ...
        private static readonly IReadOnlyDictionary<string, ActionStepCompiler> ActionStepCompilers =
            new Dictionary<string, ActionStepCompiler>(StringComparer.Ordinal)
            {
                ...
                ["mining.activate_calico_statue"] = CompileCalicoStatueStep,
                ["executor.activate_calico_statue"] = CompileCalicoStatueStep,
                ["multiplayer.manage_wallet"] = CompileMultiplayerWalletStep,
                ["executor.manage_multiplayer_wallet"] = CompileMultiplayerWalletStep,
                ["multiplayer.send_chat"] = CompileMultiplayerChatStep,
                ["executor.send_multiplayer_chat"] = CompileMultiplayerChatStep,
                ["rewards.claim_pot_of_gold"] = CompileClaimPotOfGoldStep,
                ["mining.choose_dwarf_statue_power"] = CompileDwarfKingStatuePowerStep,
                ["rewards.claim_statue_blessing"] = CompileStatueBlessingStep,
                ["world.rotate_house_plant"] = CompileHousePlantStep,
                ["world.play_singing_stone"] = CompileSingingStoneStep,
                ["world.tune_flute_block"] = CompileFluteBlockStep,
                ["world.tune_drum_block"] = CompileDrumBlockStep,
                ["farming.read_farm_computer_report"] = CompileFarmComputerStep,
                ["farming.collect_slime_ball"] = CompileSlimeBallStep,
                ["animals.withdraw_feed_hopper_hay"] = CompileFeedHopperStep,
                ["animals.collect_auto_grabber_contents"] = CompileAutoGrabberStep,
                ["movement.use_mini_obelisk"] = CompileMiniObeliskStep,
                ...
                ["fishing.manage_fish_pond"] = CompileFishPondManagementStep,
                ...
                ["executor.renovate_home"] = (action, snapshot) => CompileHomeRenovationStep(action, snapshot),
                ...
                ["executor.edit_text_sign"] = (action, _) => CompileEditTextSignStep(action),
                ...
                ["executor.use_return_scepter"] = (action, _) => CompileUseReturnScepterStep(action),
                ["executor.use_treasure_totem"] = (action, _) => CompileUseTreasureTotemStep(action),
                ["executor.use_warp_totem"] = (action, _) => CompileUseWarpTotemStep(action),
        ...
        private static readonly IReadOnlyDictionary<string, ActionParameterCompiler> ActionParameterCompilers =
            new Dictionary<string, ActionParameterCompiler>(StringComparer.Ordinal)
            {
                ...
                ["recovery.escape_object_trap"] = BuildObjectTrapRecoveryParameters,
                ["mining.activate_calico_statue"] = BuildCalicoStatueParameters,
                ["executor.activate_calico_statue"] = BuildCalicoStatueParameters,
                ["multiplayer.manage_wallet"] = BuildMultiplayerWalletParameters,
                ["executor.manage_multiplayer_wallet"] = BuildMultiplayerWalletParameters,
                ["multiplayer.send_chat"] = BuildMultiplayerChatParameters,
                ["executor.send_multiplayer_chat"] = BuildMultiplayerChatParameters,
                ["rewards.claim_pot_of_gold"] = BuildPotOfGoldParameters,
                ["mining.choose_dwarf_statue_power"] = BuildDwarfKingStatueParameters,
                ["rewards.claim_statue_blessing"] = BuildStatueBlessingParameters,
                ["world.rotate_house_plant"] = BuildHousePlantParameters,
                ["world.play_singing_stone"] = BuildSingingStoneParameters,
                ["world.tune_flute_block"] = BuildFluteBlockParameters,
                ["world.tune_drum_block"] = BuildDrumBlockParameters,
                ["farming.read_farm_computer_report"] = BuildFarmComputerParameters,
                ["farming.collect_slime_ball"] = BuildSlimeBallParameters,
                ["animals.withdraw_feed_hopper_hay"] = BuildFeedHopperParameters,
                ["animals.collect_auto_grabber_contents"] = BuildAutoGrabberParameters,
                ["movement.use_mini_obelisk"] = BuildMiniObeliskParameters,
                ["fishing.manage_fish_pond"] = BuildFishPondManagementParameters,
                ["housing.renovate"] = BuildHomeRenovationParameters,
                ["executor.renovate_home"] = BuildHomeRenovationParameters,

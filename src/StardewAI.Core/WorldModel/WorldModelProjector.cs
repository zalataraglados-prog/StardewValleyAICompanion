            ...
            return new WorldModelEnvelope
            {
                ...
                Facts = new WorldModelFacts
                {
                    ...
                    Player = ProjectFacts(snapshot, new Dictionary<string, string>
                    {
                        ...
                        ["money"] = "player.money",
                        ["total_money_earned"] = "player.total_money_earned",
                        ...
                        ["farmhouse_upgrade_level"] = "player.farmhouse_upgrade_level",
                        ["current_tool"] = "player.current_tool",
                        ["current_item_qualified_id"] = "player.current_item_qualified_id",
                        ["active_object_qualified_id"] = "player.active_object_qualified_id",

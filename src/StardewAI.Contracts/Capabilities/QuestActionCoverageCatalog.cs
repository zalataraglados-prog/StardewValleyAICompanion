    ...
    public static class QuestActionCoverageCatalog
    {
        ...
        public static IReadOnlyList<QuestActionCoverageDeclaration> All { get; } =
            new ReadOnlyCollection<QuestActionCoverageDeclaration>(new[]
            {
                ...
                Row("ordinary_quest", "ResourceCollectionQuest", "collect_resources", Bound, new[] { "collect_spawned_object", "clear_obstacle_tile", "mining_collect_quest_resource_plan_envelope" }),
                ...
                Row("special_order", "CollectObjective", "collect_items", Bound, new[] { "harvest_crop_tile" }),

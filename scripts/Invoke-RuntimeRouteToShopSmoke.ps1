...
$previousEnv = @{
    ...
    STARDEWAI_USE_DIRECT_VALIDATED_MOVEMENT = $env:STARDEWAI_USE_DIRECT_VALIDATED_MOVEMENT
...
try {
    ...
    $env:STARDEWAI_USE_DIRECT_VALIDATED_MOVEMENT = if ($HumanSpeedDiagnostics) { "false" } else { "true" }

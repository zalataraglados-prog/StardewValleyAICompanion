...
namespace StardewAI.Core.Tests
{
    public sealed class BaselineOptionRankerTests
    {
        ...
        public void RankUsesOnlyEvidenceAdmittedOptionsWhenCandidatesAreEmpty()
        {
            ...
            Assert.Equal(37, prediction.RankedOptions.Length);
            ...
            Assert.Contains(prediction.RankedOptions, item => item.OptionId == "buildings.change_skin" && item.Evidence == "unseen_option");

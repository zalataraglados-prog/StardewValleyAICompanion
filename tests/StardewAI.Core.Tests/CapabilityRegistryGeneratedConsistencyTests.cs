    ...
    public void TrainingAllowlistRequiresRuntimeEvidenceTests()
    {
        ...
        Assert.Equal(
            new[]
            {
                ...
                "skills.choose_profession", "skills.claim_mastery", "skills.read_books", "social.gift_npc", "social.talk_npc", "social.watch_movie", "story.advance_event", "story.advance_event_minigame", "tailoring.sew_item", "volcano.reach_caldera"
            },
        ...
        Assert.All(OptionCapabilityRegistrySource.TrainingAllowlist, optionId =>
        {
            ...
            var expectedScope = optionId switch
            {
                ...
                "economy.ship_items" => "vanilla_one_explicitly_authorized_unprotected_positive_shipping_payout_item_rolling_resolved_cross_map_route_bounded_local_bin_approach_plus_native_single_item_deposit_immediate_inventory_bin_receipt_and_delayed_day_settlement",
                ...
                "festival.manage_grange_display" => "vanilla_fall16_shared_team_grange_exact_live_sell_price_quality_category_optimizer_one_fresh_snapshot_native_StorageContainer_mutation_and_post_judging_retrieval_receipt",
                "festival.play_fishing_game" => "vanilla_fall16_exact_50g_100_second_native_FishingGame_stardrop_bounded_candidate_shared_predictive_legal_input_exact_stochastic_score_perfection_star_token_and_festival_return_receipt",
                "festival.play_slingshot_game" => "vanilla_fall16_exact_50g_50_second_native_TargetGame_stardrop_bounded_candidate_shared_predictive_intercept_legal_input_exact_target_schedule_accuracy_multiplier_score_star_token_and_festival_return_receipt",
                ...
                "foraging.chop_wild_tree" => "vanilla_exact_mature_seedless_mossless_untapped_base_wild_tree_locked_Data_WildTrees_native_axe_trunk_stump_fall_settlement_complete_output_domain_foraging_xp_and_TreesChopped_receipt",
                ...
                "processing.crack_geode" => "vanilla_all_eight_locked_base_geodes_exact_Blacksmith_Clint_tool_claim_money_capacity_counter_seed_and_output_projection_with_complete_shared_rng_crop_family_and_first_golden_coconut_mutex_contingency",
                "rewards.claim_adventure_guild_reward" => "vanilla_complete_unclaimed_Data_MonsterSlayerQuests_batch_exact_kill_goal_reward_dialogue_mail_flag_and_cloned_inventory_capacity_projection_native_Gil_interaction",
                ...
                "tailoring.sew_item" => "vanilla_exact_live_Data_TailoringRecipes_context_tag_pairs_Action_Tailoring_or_BC247_endpoints_boot_stat_transfer_exact_output_or_complete_native_random_domain_with_dye_branch_excluded",
